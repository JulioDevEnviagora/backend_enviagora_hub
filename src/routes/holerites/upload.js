...
router.post(
    ...
    async (req, res) => {
        ...
        try {
            ...
            console.log(
                `[Upload] Iniciando processamento de ${files?.length || 0} arquivos para competência ${competencia}`
            );
            ...
            for (const file of files) {
                try {
                    ...
                    console.log(
                        `[Upload] Processando: ${file.originalname} | Memória: ${memoryUsage.toFixed(2)}MB`
                    );
